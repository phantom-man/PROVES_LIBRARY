...
### Files Updated
1. ✅ `CANON.md` - Added §5, §6, renumbered subsequent sections
2. ✅ `FOLDER_STRUCTURE.md` - Added decision log entry
3. ✅ `archive/README.md` - Added extraction table rows
4. ✅ `docs/AGENT_BEHAVIOR_SPEC.md` - Complete rewrite for v2
