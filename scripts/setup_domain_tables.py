...
for sql in [
    ...
    try:
        ...
        pass
print("  ✓ staging/validation indexes")
...
print("\n" + "=" * 60)
print("✓ Domain tables setup complete!")
print("=" * 60)
print("\nNext steps:")
