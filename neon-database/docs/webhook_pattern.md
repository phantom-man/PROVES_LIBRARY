...
source: https://neon.com/guides/fastapi-webhooks
---

# Implementing Webhooks with FastAPI and Neon Postgres

> **Key Pattern:** This guide shows Neon's recommended approach for webhooks:
> - HTTP endpoints for receiving webhooks (FastAPI)
> - Database storage with polling/queries (NOT LISTEN/NOTIFY)
